import { Image, ImageBackground, ScrollView, ToastAndroid } from "react-native";
...
const Allterrains = ({ navigation, route }) => {
  ...
  const rednerItem = (region, index) => (
    <View style={{ width: 150, left: 40, marginTop: 30 }}>
      <TouchableOpacity
        onPress={() => {
          handleregion(region);
        }}
  ...
  return (
    <View
      style={{ backgroundColor: "black", height: "100%", paddingBottom: 20 }}
    >
      <ScrollView>
        <HorizontalPicker
          data={Items}
        ...
        {data[0] ? (
          ...
          <View style={{ marginTop: 300 }}>
            <ActivityIndicator size={100} color="darkorange" />
          </View>
        )}
      </ScrollView>
